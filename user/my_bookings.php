...
<div class="card">
    <div class="card-header">
        ...
        <a href="/webfinal/user/facilities.php" class="btn btn-primary btn-sm">Book a Facility</a>
    </div>

    <?php if (empty($bookings)): ?>
        <div class="empty-state">
            <p>Bạn chưa có booking nào.</p>
            <a href="/webfinal/user/facilities.php" class="btn btn-primary">Browse Facilities</a>
        </div>
    <?php else: ?>
                    ...
                    <tr>
                        ...
                        <td>
                            <?php if (in_array($b['status_code'], ['PENDING', 'APPROVED'])): ?>
                                <a href="/webfinal/user/cancel_booking.php?id=<?= $b['booking_id'] ?>" class="btn btn-danger btn-sm" onclick="return confirm('Cancel this booking?')">Cancel</a>
                            <?php else: ?> - <?php endif; ?>
                            <?php if ($b['admin_note']): ?>
