...
<div class="card">
    <div class="card-header">
        ...
        <div style="display:flex;gap:0.5rem;">
            <a href="<?= BASE_URL ?>/admin/categories.php" class="btn btn-secondary btn-sm">Categories</a>
            <a href="<?= BASE_URL ?>/admin/facility_rules.php" class="btn btn-secondary btn-sm">Rules</a>
            <a href="<?= BASE_URL ?>/admin/facility_form.php" class="btn btn-primary btn-sm">+ Add Facility</a>
        </div>
    </div>
                ...
                <tr>
                    ...
                    <td>
                        <div style="display:flex;flex-direction:row;gap:0.35rem;flex-wrap:nowrap;align-items:center;">
                            <a href="<?= BASE_URL ?>/admin/facility_detail.php?id=<?= $f['facility_id'] ?>" class="btn btn-sm btn-view-action">View</a>
                            <a href="<?= BASE_URL ?>/admin/facility_form.php?id=<?= $f['facility_id'] ?>" class="btn btn-sm btn-edit-action">Edit</a>
                            <a href="?delete=<?= $f['facility_id'] ?>" class="btn btn-sm btn-delete-action" onclick="return confirm('Delete this facility?')">Delete</a>
                        </div>
                    </td>
                </tr>
                <?php endforeach; ?>
